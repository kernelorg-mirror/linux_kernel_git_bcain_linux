 ...
 *
 * Useful in arch idle paths to drain the call_single_queue before
 * entering a deep idle state, keeping call_single_data_t objects
 * locked for the minimum time.
 *

/*
 * linux/arch/hexagon/platform/msm8998/board.c
 *
...
static const char *msm8998_dt_compat[] __initconst = {
	"qcom,msm8998",
	NULL
};
...
static int __init msm8998_init(void)
{
	printk("%s\n", __func__);

	if (strcmp(mdesc->name,"msm8998")) {
		printk("omg not msm8998!!!\n");
		return 0;
	}
 ...
 */
arch_initcall(msm8998_init);


void setup_arch_platform_msm8998(void)
{
	printk("%s\n", __func__);
...
MACHINE_START(MSM8998, "msm8998")
	.setup_arch_platform = setup_arch_platform_msm8998,
	.dt_compat = msm8998_dt_compat
MACHINE_END

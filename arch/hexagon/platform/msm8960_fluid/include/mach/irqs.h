...
//  We have HEXAGON_CPUINTS; also we preset our NR_IRQS since whether the hypervisor takes control of all interrupts is somewhat in flux
#define NR_MSM_IRQS 0 /* 32 + 128 */
#endif

...
//  ugh, forget this noise.
#define remote_spinlock_t		int
#define remote_spin_lock_init(a,b)	do {} while (0)
#define remote_spin_lock(a)		do {} while (0)
#define remote_spin_unlock(a)		do {} while (0)

...
/*
 * When ioremap or vmalloc creates new page table entries, we must
 * invalidate any stale TLB entries covering the same virtual range.
 * Without this, large boot-time BKP mappings shadow the new PTEs.
 */

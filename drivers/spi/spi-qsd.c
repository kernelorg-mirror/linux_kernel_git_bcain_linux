...
int msm_spi_wait_valid(struct msm_spi *dd)
{
	 ...
	 * to occur
	 */
	delay = (100 * USEC_PER_SEC) / dd->clock_speed;
	/*
...
skip_dma_resources:
...
#else
		dev_err(&pdev->dev, "uh oh...  someone needs remote lock support\n");
#endif
	}
	...
	//  wait, how does this even work on 8974 then?!
